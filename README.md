...
Frascà and Leonardo Pannunzio.
In 2026, we are even closer to the target date of the 2030 Agenda, yet only 35% of the
set targets have been achieved. In particular, Goal 13, the one concerning the struggle against 
climate change, is still severely compromised.
...
Frascà e Leonardo Pannunzio.
Nel 2026 siamo ancora più vicini alla data di arrivo dell’Agenda 2030, eppure solo il 35% dei
target prefissati è stato raggiunto. In particolare l’obbiettivo 13, ossia quello
riguardante la lotta al cambiamento climatico, è ancora severamente compromesso.
